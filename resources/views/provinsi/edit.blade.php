...
<head>
    ...
    <title>Edit Provinsi - Tendako</title>
    ...
    <div class="min-h-screen flex flex-col justify-center py-12 sm:px-6 lg:px-8">
        ...
        <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
            <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
                ...
                <form method="POST" action="{{ route('provinsi.update', $provinsi->kodedagri_prv) }}" class="space-y-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div>
                        ...
                        <div class="mt-1 relative">
                            <input type="number" id="kodedagri_prv" name="kodedagri_prv" value="{{ old('kodedagri_prv', $provinsi->kodedagri_prv) }}" required
                    ...
                    <div>
                        ...
                        <div class="mt-1 relative">
                            <input type="text" id="namadagri_prv" name="namadagri_prv" value="{{ old('namadagri_prv', $provinsi->namadagri_prv) }}" required
                                   class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md placeholder-gray-400 focus:outline-none focus:ring-orange-500 focus:border-orange-500 sm:text-sm"
                    ...
                    <div>
                        ...
                        <div class="mt-1 relative">
                            <input type="number" id="kodebps_prv" name="kodebps_prv" value="{{ old('kodebps_prv', $provinsi->kodebps_prv) }}" required
                                   class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md placeholder-gray-400 focus:outline-none focus:ring-orange-500 focus:border-orange-500 sm:text-sm">
                            <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                    ...
                    <div>
                        ...
                        <div class="mt-1 relative">
                            <input type="text" id="namabps_prv" name="namabps_prv" value="{{ old('namabps_prv', $provinsi->namabps_prv) }}" required
                                   class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md placeholder-gray-400 focus:outline-none focus:ring-orange-500 focus:border-orange-500 sm:text-sm"
                                   placeholder="Contoh: Jawa Barat">
                            <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                    ...
                    <div>
                        ...
                        <div class="mt-1 relative">
                            <input type="text" id="idgeojson_prv" name="idgeojson_prv" value="{{ old('idgeojson_prv', $provinsi->idgeojson_prv) }}"
                                   class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md placeholder-gray-400 focus:outline-none focus:ring-orange-500 focus:border-orange-500 sm:text-sm"
                    ...
                    <div>
                        ...
                        <div class="mt-1 relative">
                            <input type="number" id="kodegeojson_prv" name="kodegeojson_prv" value="{{ old('kodegeojson_prv', $provinsi->kodegeojson_prv) }}"
                                   class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md placeholder-gray-400 focus:outline-none focus:ring-orange-500 focus:border-orange-500 sm:text-sm"
                                   placeholder="Optional">
                            <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
